...
<body>
    ...
    <div id="main__imgbox">
        <div class="imgbox__textbox layout--width">
            <p class="imgbox__textleft pist-absolute"><strong>DISCOVER & SHOP</strong><br>THE SENSETIVE</p>
    ...
    <div id="main__pick">
        <div class="main__pick layout--width row-box">
            <div class="pick__product--text">
                <strong class="title--color--first">TODAY'S PICK</strong><br><a href="#">브랜드 더보기 ></a>
            </div>
